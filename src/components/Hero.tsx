  ...
  return (
    <section className="border-b border-cream-darker bg-cream">
      <div className="mx-auto max-w-6xl px-6 pt-12 pb-10 text-center sm:pt-20 sm:pb-16">
        ...
        <dl className="mx-auto mt-10 grid max-w-6xl grid-cols-2 divide-x divide-y divide-cream-darker border border-cream-darker text-left sm:mt-16 sm:grid-cols-4 sm:divide-y-0">
          {stats.map((stat) => (
